...
const App: React.FC = () => {
  ...
  return (
    <div className={`relative min-h-screen w-full transition-colors duration-1000 ease-in-out overflow-hidden flex flex-col font-sans text-white ${currentSceneConfig.bgClass}`}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                {Object.values(SceneType).map((s) => (
                  ...
                  >
                    {s === SceneType.LAB ? '實驗室' : s === SceneType.CLASSROOM ? '教室' : '家'}
                  </button>
                ))}
              </div>
            </div>
