...
// 音樂 (使用 SoundHelix 測試源，確保可播放)
export const SONGS: Song[] = [
  { id: 1, title: "Jingle Bells (Test)", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3" },
  { id: 2, title: "Deck the Halls (Test)", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3" },
  { id: 3, title: "Silent Night (Test)", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3" },
  { id: 4, title: "Christmas Magic (Test)", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3" },
  { id: 5, title: "Relaxing (Test)", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3" }
];
